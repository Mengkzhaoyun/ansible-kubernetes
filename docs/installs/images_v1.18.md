...
```bash
# kube-apiserver
docker pull gcr.io/google-containers/kube-apiserver:v1.18.2 &&\
docker tag gcr.io/google-containers/kube-apiserver:v1.18.2 registry.cn-qingdao.aliyuncs.com/wod/kube-apiserver:v1.18.2 &&\
docker push registry.cn-qingdao.aliyuncs.com/wod/kube-apiserver:v1.18.2

# kube-controller-manager
docker pull gcr.io/google-containers/kube-controller-manager:v1.18.2 &&\
docker tag gcr.io/google-containers/kube-controller-manager:v1.18.2 registry.cn-qingdao.aliyuncs.com/wod/kube-controller-manager:v1.18.2 &&\
docker push registry.cn-qingdao.aliyuncs.com/wod/kube-controller-manager:v1.18.2

# kube-scheduler
docker pull gcr.io/google-containers/kube-scheduler:v1.18.2 &&\
docker tag gcr.io/google-containers/kube-scheduler:v1.18.2 registry.cn-qingdao.aliyuncs.com/wod/kube-scheduler:v1.18.2 &&\
docker push registry.cn-qingdao.aliyuncs.com/wod/kube-scheduler:v1.18.2

# hyperkube
docker pull gcr.io/google-containers/hyperkube:v1.18.2 &&\
docker tag gcr.io/google-containers/hyperkube:v1.18.2 registry.cn-qingdao.aliyuncs.com/wod/hyperkube:v1.18.2 &&\
docker push registry.cn-qingdao.aliyuncs.com/wod/hyperkube:v1.18.2

# kube-proxy
docker pull gcr.io/google-containers/kube-proxy:v1.18.2 &&\
docker tag gcr.io/google-containers/kube-proxy:v1.18.2 registry.cn-qingdao.aliyuncs.com/wod/kube-proxy:v1.18.2 &&\
docker push registry.cn-qingdao.aliyuncs.com/wod/kube-proxy:v1.18.2
